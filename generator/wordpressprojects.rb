...
# write result
File.open("#{File.dirname(__FILE__)}/../public/wordpressprojects.html", 'w') { |file| file.write(ERB.new(File.read("#{File.dirname(__FILE__)}/templates/wordpressprojects.html")).result(binding)) } 
